...
const Header = () => {
    ...
    return (
        <>
        <header>
            <div className='flex fixed w-full z-[10] bg-[#fff]  text-center items-center justify-between gap-8 px-3 py-3 shadow-md'>
              ...
              <path d="M4.268 1H12a1 1 0 0 1 1 1v11.768l.223.148A.5.5 0 0 0 14 13.5V2a2 2 0 0 0-2-2H6a2 2 0 0 0-1.732 1"/>
                ...
                <h1 className='logo tracking-wide text-blue-400 text-xl'>KeepSter</h1>
              </div>
